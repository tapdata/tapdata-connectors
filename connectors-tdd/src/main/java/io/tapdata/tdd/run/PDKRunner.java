...
public class PDKRunner {
    ...
    public static final String BASE_CONF_PATH = "connectors-tdd/src/main/resources/run/";
...
//        CodingDemo("coding-demo-connector-v1.0-SNAPSHOT.jar", "coding-js.json"),
        HuDi("hudi-connector-v1.0-SNAPSHOT.jar", "hudi.json"),
        ;
        String path;
        String conf;
