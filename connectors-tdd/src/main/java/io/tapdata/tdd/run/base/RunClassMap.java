package io.tapdata.tdd.run.base;

import java.util.Objects;
import java.util.StringJoiner;

public enum RunClassMap {
    BATCH_COUNT_RUN("1", "io.tapdata.tdd.run.support.BatchCountRun", "BatchCountFunction", new String[]{"batchCount"}, "BatchCountRun"),
    BATCH_READ_RUN("2", "io.tapdata.tdd.run.support.BatchReadRun", "BatchReadFunction", new String[]{"batchRead"}, "BatchReadRun"),
    COMMAND_RUN("3", "io.tapdata.tdd.run.support.CommandRun", "", new String[]{"commandCallback"}, "CommandRun"),
    CONNECTION_TEST_RUN("4", "io.tapdata.tdd.run.support.ConnectionTestRun", "", new String[]{"connectionTest"}, "ConnectionTestRun"),
    DISCOVER_SCHEMA_RUN("5", "io.tapdata.tdd.run.support.DiscoverSchemaRun", "", new String[]{"discoverSchema"}, "DiscoverSchemaRun"),
    STREAM_READ_RUN("6", "io.tapdata.tdd.run.support.StreamReadRun", "", new String[]{"streamRead"}, "StreamReadRun"),
    TABLE_COUNT_RUN("7", "io.tapdata.tdd.run.support.TableCountRun", "", new String[]{"tableCount"}, "TableCountRun"),
    TIMESTAMP_TO_STREAM_OFFSET_RUN("8", "io.tapdata.tdd.run.support.TimestampToStreamOffsetRun", "", new String[]{"timestampToStreamOffset"}, "TimestampToStreamOffsetRun"),
    WEB_HOOK_EVENT_RUN("9", "io.tapdata.tdd.run.support.WebHookEventRun", "", new String[]{"webhookEvent"}, "WebHookEventRun"),
    WRITE_RECORD_RUN("10", "io.tapdata.tdd.run.support.WriteRecordRun", "", new String[]{"writeRecord", "insertRecord", "updateRecord", "deleteRecord"}, "WriteRecordRun"),
    ;
    String classPath;
