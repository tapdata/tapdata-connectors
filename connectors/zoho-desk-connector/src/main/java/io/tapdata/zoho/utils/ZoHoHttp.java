...
public class ZoHoHttp {
    ...
    private HttpNormalEntity heard;
    private HttpEntity body;
    private HttpEntity form;
    private HttpType httpType;
    private String url;
    private HttpNormalEntity resetFull;
    ...
    public static ZoHoHttp create(String url, HttpType httpType, HttpNormalEntity heard) {
        return new ZoHoHttp().url(url).httpType(httpType).header(heard);
    }

    public static ZoHoHttp create(String url, HttpType httpType, HttpNormalEntity heard, HttpEntity body) {
    ...
    public ZoHoHttp body(HttpEntity body) {
        this.body = body;
        return this;
    }

    public ZoHoHttp header(HttpNormalEntity header) {
        this.heard = header;
        return this;
    }
    ...
    public ZoHoHttp resetFull(HttpNormalEntity resetFull) {
        this.resetFull = resetFull;
        return this;
    }

    public ZoHoHttp form(HttpEntity form) {
        this.form = form;
        return this;
    }
...
//            TapLogger.info(TAG,"Http[POST] read timed out:{}",e.getMessage());
    ...
    public HttpNormalEntity getHeard() {
        return heard;
    }
    ...
    public HttpNormalEntity getResetFull() {
        return resetFull;
    }
