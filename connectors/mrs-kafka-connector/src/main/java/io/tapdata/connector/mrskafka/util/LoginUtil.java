...
public class LoginUtil {
    ...
    // 分区类名
    public final static String PARTITIONER_NAME = "partitioner.class";
    ...
    public static void securityPrepare(String principal, String keyTabFile) throws IOException {
        String filePath = System.getProperty("user.dir") + File.separator + "tapdata-connectors" + File.separator + "connectors" + File.separator + "mrs-kafka-connector" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator;
...
//        String krbFilePath = "D:"+File.separator +"project"+ File.separator +"huaweiclou-mrs-example-mrs-3.2.1.1"+ File.separator +"src"+ File.separator +"kafka-examples" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "kafkaSecurityMode"+ File.separator +"krb5.conf";
        Properties securityProps = new Properties();
        String krbFilePath = "D:\\project\\huaweicloud-mrs-example-mrs-3.2.1.1\\src\\kafka-examples\\src\\main\\resources\\kafkaSecurityMode\\krb5.conf";
        // file does not exist.
