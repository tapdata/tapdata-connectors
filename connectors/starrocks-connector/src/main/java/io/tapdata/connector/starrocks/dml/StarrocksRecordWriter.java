...
public class StarrocksRecordWriter extends NormalRecordWriter {

    protected StarrocksStreamWriteRecorder streamRecorder;

    public StarrocksRecordWriter(JdbcContext jdbcContext, TapTable tapTable) throws SQLException {
    ...
    public void write(List<TapRecordEvent> tapRecordEvents, Consumer<WriteListResult<TapRecordEvent>> writeListResultConsumer, Supplier<Boolean> isAlive) throws SQLException {
        ...
        for (TapRecordEvent recordEvent : tapRecordEvents) {
            ...
            if (recordEvent instanceof TapInsertRecordEvent) {
                ...
                //更新事件，需要考虑更多的因素
                if (Boolean.FALSE.equals(((StarrocksConfig) commonDbConfig).getJdbcCompletion())) {
                    //未开启jdbc补全，只能使用导入模式
