 ...
 **/
public class StarrocksStreamTest {
	// FE IP Address
	...
	public static void main(String[] args) throws Exception {
		StarrocksStreamTest StarrocksStreamTest = new StarrocksStreamTest();
		//file load
		//File file = new File(LOAD_FILE_NAME);
		//loader.load(file);
		//json load
		String jsonData = "[{\"_id\":\"63ae86cb399dff531d4165cf\",\"id\":1.0,\"name\":\"test1\",\"age\":12.0,\"__Starrocks_DELETE_SIGN__\":\"0\"}]";
		StarrocksStreamTest.loadJson(jsonData);
	}
}
