...
public class HuDiWriteBySparkClientV2 extends HudiWrite {
    ...
    AutoExpireInstance<TapTable, String, ClientPerformer> autoExpireInstance;
    public HuDiWriteBySparkClientV2(HiveJdbcContext hiveJdbcContext, HudiConfig hudiConfig, Supplier<Boolean> isAlive, Log log) {
        ...
        autoExpireInstance.call(tapTable, (clientPerformer) -> {
            ...
            try {
                ...
                synchronized (clientEntityLock) {
                    if (clientPerformer.usage) {
                        clientPerformer.releaseUsage();
                    }
                }
